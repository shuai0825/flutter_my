...
class BannerRecycle extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return new BannerRecycleState();
  }
}

class BannerRecycleState extends State<BannerRecycle>{
